...
\section{15. March - Adversarial Search}%
\label{sub:_adversarial_search}


\section{23. March - Constraint Satisfaction Problems}%
\label{sec:23_march_constraint_satisfaction_problems}



\section{12. April - Probability}%
\label{sec:12_march_probability}

\section{20. April - Bayesian Networks}%
\label{sec:20_march_bayesian_networks}

\section{27. April - Hidden Markov Models}%
\label{sec:27_march_hidden_markov_models}

\section{3. May - Intro to Machine Learning}%
\label{sec:}
